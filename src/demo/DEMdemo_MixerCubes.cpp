...
int main() {
    ...
    // Load a 12-triangle unit cube once, then instantiate it many times.  Marking it convex and never-winner follows
    // the mesh-particle demos and reduces unnecessary contact-island work for these tiny rigid particles.
    auto cube_template =
