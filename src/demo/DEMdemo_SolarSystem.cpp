...
// with serious sizes. Also in most cases, you can use owner wildcards
// (AddOwnerWildcard) to associate extra properties to be used in the force
// model.
// =============================================================================
...
int main() {
    ...
    Sun->AddOwnerWildcard("my_mass", 1.989e30);
    ...
    Io->AddOwnerWildcard("my_mass", 8.9319e22);
    ...
    Europa->AddOwnerWildcard("my_mass", 4.7998e22);
    ...
    Ganymede->AddOwnerWildcard("my_mass", 1.4819e23);
    ...
    Callisto->AddOwnerWildcard("my_mass", 1.0759e23);
    ...
    Moon->AddOwnerWildcard("my_mass", 7.342e22);
    */
