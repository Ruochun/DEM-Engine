...
void DEMForceModel::SetForceModelType(FORCE_MODEL model_type) {
    ...
    switch (model_type) {
        case (FORCE_MODEL::HERTZIAN):
            m_must_have_mat_props = {"E", "nu", "CoR", "mu", "Crr", "Cohesion"};
            m_pairwise_mat_props = {"CoR", "mu", "Crr", "Cohesion"};
        ...
        case (FORCE_MODEL::HERTZIAN_FRICTIONLESS):
            m_must_have_mat_props = {"E", "nu", "CoR", "Cohesion"};
            m_pairwise_mat_props = {"CoR", "Cohesion"};
